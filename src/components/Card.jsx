  ...
  return (
    ...
    <div className="bg-white p-6 mt-10 rounded-lg shadow-md min-w-[220px]">
      <div className="text-center">
        <span className="block text-lg font-bold texy-slate-700">{location.name}</span>
      ...
      <div className="font-bold text-slate-700 flex justify-center mt-4 mb-2">
        <span className="text-8xl font-bold text-slate700">{current.temp_c}</span>
        <span className="text-2xl font-bold text-slate700 mt-2">ºC</span>
      </div>
